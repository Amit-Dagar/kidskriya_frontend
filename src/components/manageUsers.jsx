...
export default class manageUsers extends PureComponent {
  ...
  deleteUser = async () => {
    axios.delete(
      server + "/api/auth/delete/" + this.state.userID,
      this.state.config
    );
  };
          ...
          <div className="row d-flex justify-content-center">
            <div className="card border-0 shadow">
              <div className="card-body">
                <h2 className="h3 mb-1 text-center">Manage Users</h2>
                <div className="row pt-3 mx-n2">
                  {users.map((user, index) =>
                    user.is_active ? (
                      <div
                        className="col-lg-6 d-flex justify-content-between align-items-center"
                        key={index}
                      >
